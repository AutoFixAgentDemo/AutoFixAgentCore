...
from .const import IGNORED_MESSAGE_ID
...
class Memory(BaseModel):
    ...
    def try_remember(self, keyword: str) -> list[Message]:
        """Try to recall all messages whose label containing a specified keyword"""
        return [message for message in self.storage if keyword in message.label]
