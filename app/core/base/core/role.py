...
from .provider import HumanProvider
from .repair_llm_raw_output import extract_state_value_from_output
from .schema import Message, MessageQueue, SerializationMixin
from .utils.common import any_to_name, any_to_str, role_raise_decorator
from pydantic import BaseModel, ConfigDict, Field, SerializeAsAny, model_validator

if TYPE_CHECKING:
    from .environment import Environment  # noqa: F401

PREFIX_TEMPLATE = """You are {profile}, named {name}, your goal is {goal}. """
...
class RoleContext(BaseModel):
    ...
    def model_rebuild(cls, **kwargs):
        from .environment.base_env import Environment  # noqa: F401
